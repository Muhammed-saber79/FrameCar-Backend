    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
                    ...
                    <div class="row">
                        <div class="col-xl-12 d-flex flex-column flex-xl-row mx-auto gap-1">
                            ...
                            <div class="mb-3 col-md-12 col-xl-4">
                                ...
                                <input type="text" name="carType" id="carType" placeholder="ادخل نوع السيارة" class="form-control col-xl-5" value="{{ old('carType') }}" @error('carType') style="border-color: red" @enderror>
                                @error('carType')
                            ...
                            <div class="mb-3 col-md-12 col-xl-4">
                                ...
                                <input type="text" name="carModel" id="carModel" placeholder="ادخل موديل السيارة" class="form-control col-xl-5" value="{{ old('carModel') }}" @error('carModel') style="border-color: red" @enderror>
                                @error('carModel')
                                <small id="helpId" style="color: red; display: block">{{ $message }}</small>
                                @enderror
                            </div>
                            ...
                            <div class="mb-3 col-md-12 col-xl-4">
                                ...
                                <input type="text" name="carMadeYear" id="carMadeYear" placeholder="ادخل سنة صنع السيارة" class="form-control col-xl-5" value="{{ old('carMadeYear') }}" @error('carMadeYear') style="border-color: red" @enderror>
                                @error('carMadeYear')
                                <small id="helpId" style="color: red; display: block">{{ $message }}</small>
                                @enderror
                            </div>
                        ...
                        <div class="col-xl-12 d-flex flex-column flex-xl-row mx-auto gap-2">
                            <div class="mb-3 col-xl-6">
                                ...
                                <input type="date" name="date" id="date" placeholder="ادخل نوع السيارة" class="form-control col-xl-5" value="{{ old('date') }}" @error('date') style="border-color: red" @enderror min="{{ now()->format('Y-m-d') }}">
                        ...
                        <div class="col-xl-12 d-flex flex-column flex-xl-row mx-auto gap-1">
                            ...
                            <div class="mb-3 col-md-12 col-xl-4">
                                ...
                                <input type="file" name="car_front_image_1" id="car_front_image_1" placeholder="قم برفع صورة السيارة بالكامل من الأمام" class="form-control  col-xl-5" accept="image/*" @error('car_front_image_1') style="border-color: red" @enderror>
                            ...
                            <div class="mb-3 col-md-12 col-xl-4">
                                ...
                                <input type="file" name="car_back_image_1" id="car_back_image_1" placeholder="قم برفع صورة السيارة واضحة من الخلف" class="form-control  col-xl-5" accept="image/*" @error('car_back_image_1') style="border-color: red" @enderror>
                            ...
                            <div class="mb-3 col-md-12 col-xl-4">
                                ...
                                <input type="file" name="camera_image_1" id="camera_image_1" placeholder="قم برفع صورة حساس أو كاميرا ان وجد" class="form-control  col-xl-5" accept="image/*" @error('camera_image_1') style="border-color: red" @enderror>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-outline-info" onclick="validate()">إرسال</button>
            </div>
...
<script>
    ...
    function validateForm() {
        ...
        var car_front_image_1 = $("#car_front_image_1").val();
        if (car_front_image_1 === "") {
            displayErrorMessage("#car_front_image_1", "هذا الحقل مطلوب");
            isValid = false;
        }
        var servicePlace = $("#servicePlace").val();
        if (servicePlace === "") {
