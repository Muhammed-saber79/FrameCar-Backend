            ...
            <div class="modal-body">
                ...
                <form id="newOrder" action="{{ route('order.store') }}" method="POST" enctype="multipart/form-data" style="margin: 0 auto; text-align: right;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-6" id="location">
                        ...
                        <div class="col-xl-6">
                            <x-form.input label="تاريخ الصيانة" id="date" labelStyle="margin-top: 15px" type="date" name="date" placeholder="" value="" style="width: 100%; padding: 10px; border: 1px solid #ccc; border-radius: 5px;" />
